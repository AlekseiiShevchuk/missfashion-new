...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('is_main', 'Is this item main or not (subItem)?*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    @endif
                    {!! Form::label('image', 'Image for menu item (only for subItems)', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('subitems', 'Subitems (only if item is main)', ['class' => 'control-label']) !!}
